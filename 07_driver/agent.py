"""Step 7 — the agent is UNCHANGED from Step 5 (diff them: only this docstring).

That is the lesson: going from "I drive it by hand" to "it runs in production"
changes NOTHING about the agent. What changes is WHO CALLS drive() — see
drive.py and sweeper.py.

POC env flags (same as Step 5):
